 ...
 * Copyright (c) [2024] [Mohammad Hashim]
 * All rights reserved.
 */
...
void database()
{
	...
	if(strcmp(pass,password)==0)
	{
		...
		{
			cout << "\n\t\t\t\t\t --- ADMINISTRATOR MENU --- \n";
			cout << "1. Create New Train Database \n";
			cout << "2. Add Train \n";
			...
			{
				case 1:
					f.open("train.txt",ios::out|ios::binary);
					do
					{
					a.getDetail();
					...
					break;
				case 2:
					f.open("train.txt",ios::in|ios::out|ios::binary|ios::app);
					a.getDetail();
					f.write((char *) & a,sizeof(a));
					f.close();
					break;
...
void res()
{
    ...
    fstream f1, f2;
    time_t t;
    f1.open("train.txt", ios::in | ios::out | ios::binary);
...
{
    fstream f;
    f.open("train.txt",ios::in|ios::out|ios::binary);
    Detail a;
    while(f.read((char *) & a,sizeof(a)))
    {
            a.displaydetail();
